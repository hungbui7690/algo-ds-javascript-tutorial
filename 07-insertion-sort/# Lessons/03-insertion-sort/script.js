...
/*
  ...
  Best: data mostly sorted 
  >> ko cần phải làm gì nhiều cả, do condition đã cover hết
  
  Worst: [9,8,7,6] 
  >> thứ tự bị reverse 
  >> phải làm từ đầu tới cuối

  Thằng này work ok trong trường hợp streaming, 
  > khi data nhảy vào liên tục, lúc này chỉ cần insert vào là xong
